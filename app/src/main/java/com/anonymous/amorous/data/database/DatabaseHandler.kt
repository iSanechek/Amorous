...
interface LocalDatabase {
    ...
    suspend fun getThumbnailsCandidate(parameter: String, limit: Int): List<Candidate>
    fun updateThumbnailsStatus(uid: String, status: String)
    suspend fun getOriginalsCandidate(parameter: String): List<Candidate>
    suspend fun getBackupCandidate(parameter: String): List<Candidate>
...
//            uid = c.getString(c.getColumnIndex(Candidate.COLUMN_UID)),
